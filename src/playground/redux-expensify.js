...
//Reducer takes only state and an action
...
// tracks the changes to the state
store.subscribe(() => {
...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 1000, createdAt: 3000 }));
